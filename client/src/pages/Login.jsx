    ...
    text-indigo-300 text-sm'>
      ...
      <form onSubmit={onSubmitHandler}>
        ...
        {state === 'Sign up' ? (<p className='text-gray-400 text-center text-xs mt-4'>Already have an account?{' '}
         <span className='text-indigo-500 cursor-pointer' onClick={() => setState('Login')}>
          Login here</span></p>): ( <p className='text-gray-400 text-center text-xs mt-4'>Don't have an account?{' '}
         <span className='text-indigo-500 cursor-pointer' onClick={() => setState('Sign up')}>Sign up here</span></p>
    )}
